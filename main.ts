...
//----------------------------------------------------------------------------------------------------------------
class madKing {
    constructor(private dupe?: boolean, private original?: boolean) {

    }
    checkOriginality = (statRece: boolean) => {
        return statRece ? this.dupe = statRece : (!statRece? this.dupe = statRece ) ;
    }
    get X() {
        return this.dupe;
    }
